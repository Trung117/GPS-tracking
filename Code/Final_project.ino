...
const String myphone = "84964124172";
...
void sent_data(String datasent)
{
  ...
  updateSerial();
  mySerial.println("AT+CMGS=\"+84964124172\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
  mySerial.print("VI TRI HIEN TAI: \n http://www.google.com/maps/place/"+datasent); //text content_____Ex: mySerial.println("TRUNG_sim800a sms CANH BAO TROM");
  updateSerial();
...
void sent_data_tracking(String datasent)
{
  ...
  mySerial.println("AT+CMGS=\"+84964124172\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
  mySerial.print("#a "+datasent); //text content_____Ex: mySerial.println("TRUNG_sim800a sms CANH BAO TROM");
  updateSerial();
  mySerial.write(26);  // mySerial.println((char)26);
  ss.listen();  //Accept just only 1 uart enable
}
...
void check()
{
  ...
  else if (!(strncmp(str, "tracking", 8)))
  {
     ss.listen();
    while (sendonce == false)
    {
...
void MakeCall()
{
  mySerial.println("ATD+84964124172;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
