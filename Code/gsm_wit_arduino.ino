...
void setup()
{
  ...
  Serial.println("s : to send message");     //Important test
  Serial.println("r : to receive message");
  Serial.println("c : to make a call");     //Important test
...
void ReceiveMessage()
{
  mySerial.println("AT+CNMI=2,2,0,0"); // AT Command to recieve a live SMS
  delay(1000);
  if (mySerial.available()>0)
  {
    msg=mySerial.read();
